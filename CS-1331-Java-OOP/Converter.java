public class Converter {
    ...
    public static void main(String[] args) {
        ...
        printCelsiusConversionTable(31, 35);
        System.out.println(fahrenheitWarmer(100, 0));
    ...
    public static void printFahrenheitConversionTable(int lower, int upper) {
        ...
        for (current = lower; current <= upper; current++) {
            System.out.printf("Fahrenheit: " + current + " -> Celsius: " + "%.3f\n", fahrenheitToCelsius(current));
        }
    ...
    public static void printCelsiusConversionTable(int lower, int upper) {
        while (lower <= upper) {
            System.out.printf("Celsius: " + lower + " -> Fahrenheit: " + "%.3f\n", celsiusToFahrenheit(lower));
            lower++;
        }
    ...
    public static boolean fahrenheitWarmer(int fahrenheit, int celsius) {
        return ((fahrenheit > celsiusToFahrenheit(celsius)) ? fahrenheit : celsiusToFahrenheit(celsius)) == fahrenheit;
